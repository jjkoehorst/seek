...
data_file1.creators = [$guest_person]
...
data_file1.license = 'CC-BY-4.0'
data_file1.content_blob = ContentBlob.new(original_filename: 'ValidationReference.xlsx',
                                          content_type: 'application/vnd.openxmlformats-officedocument.spreadsheetml.sheet')
disable_authorization_checks do
  data_file1.save
  data_file1.annotate_with(['metabolite concentrations', 'thermophile', 'enzymology'], 'tag', $guest_person)
...
# Create attribution relationship between data_file2 and model
disable_authorization_checks do
  attribution_relationship = RelationshipType.where(title: 'Attribution').first
  data_file2.attributions.create(other_asset: model, relationship_type: attribution_relationship) if attribution_relationship
end
...
sop.license = 'CC-BY-4.0'
sop.annotate_with(['protocol', 'enzymology'], 'tag', $guest_person)
sop.creators = [$admin_person, $guest_person]
