...
enzyme_sample_type.policy = Policy.create(name: 'publicly downloadable policy', sharing_scope: Policy::EVERYONE, access_type: Policy::ACCESSIBLE)
...
culture1.creators = [$guest_person]
...
culture1.annotate_with(['thermophile', 'bacterial culture', 'stationary phase'], 'tag', $guest_person)
culture1.save!
...
culture2.creators = [$guest_person]
...
culture2.annotate_with(['thermophile', 'bacterial culture', 'log phase'], 'tag', $guest_person)
culture2.save!
...
enzyme1.annotate_with(['enzyme', 'kinase', 'gluconeogenesis'], 'tag', $guest_person)
enzyme1.save!
...
enzyme2.annotate_with(['enzyme', 'dehydrogenase', 'gluconeogenesis'], 'tag', $guest_person)
enzyme2.save!
...
enzyme3.annotate_with(['enzyme', 'isomerase', 'gluconeogenesis'], 'tag', $guest_person)
enzyme3.save!
...
enzyme4.creators = [$guest_person]
enzyme4.contributor = $guest_person
enzyme4.policy = Policy.create(name: 'publicly downloadable policy', sharing_scope: Policy::EVERYONE, access_type: Policy::ACCESSIBLE)
...
enzyme4.annotate_with(['enzyme', 'aldolase', 'phosphatase', 'gluconeogenesis'], 'tag', $guest_person)
enzyme4.save!
